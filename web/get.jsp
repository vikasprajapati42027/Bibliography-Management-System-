...
<html>
    ...
    <body>
        <%
            ...
            if(dao.Insert(obj.getTitle(),obj.getAuthor(),obj.getP_year(),obj.getPublisher(),obj.getPlace())>0)
            {
                out.println("<script>alert('Data inserted');window.location.href='index.jsp';</script>");
            }
            else
            {
                    out.println("<script>alert('data fill');window.location.href='create.html';</script>");
